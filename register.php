...
if(isset($_POST['create_btn']))
{
    ...
    $pass_encript = password_hash($psw, PASSWORD_DEFAULT);
...
<html lang="en">
    <head>
        ...
        <title>Register - Component Warehouse</title>
                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputName" type="text" placeholder="username" name="username" required/>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid">
                                                    <input type="submit" class="btn btn-info " value="Create Account" name="create_btn">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
