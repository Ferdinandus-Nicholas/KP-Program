...
//Data barang
$arr1 = [];
$sql = "SELECT Kode, Nama_Barang, Jumlah FROM tabel_stok_barang WHERE Username = '".$user."'";
...
if(isset($_POST['simpan_btn']))
{
    ...
    $sql = "SELECT Kode FROM tabel_stok_barang WHERE Username = '".$user."' and Kode = '$kode'";
    echo "<script type='text/javascript'>alert('$$sql');</script>";
    if ($sql == $kode) {
        $info = "benar";
        $sql="update tabel_stok_barang set 
        Kode='$kode',
        Nama_barang='$nama' where Username = '$user' and Kode='$kode'";
    ...
    $sql2="insert into tabel_stok_barang(Kode, Nama_Barang, Jumlah, Username) values('$kode', '$nama', $jumlah, '$user')";
    echo "<meta http-equiv='refresh' content='0'>";
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="nav justify-content-end">
                            <!-- <a href="#" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
        ...
        <!--popup -->
        <div class="modal fade" data-keyboard="false" id="staticBackdrop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="tables.php?username=<?php print $user?>">
                        <div class="modal-body">
                            <div class="form-group">
                                <label style="color:black;text-align:right;">Kode Barang</label>
                                <input name="kode" type="text" class="form-control" id="" placeholder="Kode Barang..." required>
                            </div>
                            <div class="form-group">
                                <label style="color:black;text-align:right;">Nama Barang</label>
                                <input name="nabar" type="text" class="form-control" id="" placeholder="Nama barang..." required>
                            </div>
                            <div class="form-group">
                                <label style="color:black;text-align:right;">Jumlah</label>
                                <input name="jumlah" type="text" class="form-control" id="" placeholder="Jumlah..." required>
                            </div>
