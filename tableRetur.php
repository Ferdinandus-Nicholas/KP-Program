...
$arr1 = [];
$sql = "SELECT Kode, Tanggal_retur, Nama_Barang, Jumlah FROM tabel_barang_retur WHERE Username = '".$user."'";
  ...
  while($row=$result->fetch_assoc())
    {
      $arr=array("Kode"=>trim($row['Kode']),
      "Nama_Barang"=>trim($row['Nama_Barang']),
      "Tanggal_retur"=>trim($row['Tanggal_retur']),
      "Jumlah"=>trim($row['Jumlah']),
      "Username"=>trim($user));
      array_push($arr1,$arr); 
    }
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="nav justify-content-end">
                            <?php
                                print "<a href='inputBarangRetur.php?username=".$user."' class='btn btn-sm btn-success' >";
                            ?>         
